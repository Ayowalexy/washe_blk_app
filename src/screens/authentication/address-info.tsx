  ...
  return (
    <View>
      ...
      >
        ...
        <View marginTop={20} backgroundColor={theme.secondary3} padding={24}>
          <Text
            fontSize={13}
            color={theme?.red?.val}
            fontFamily="$body"
          ...
          <Text color={theme?.secondary7?.val} fontSize={14} marginTop={5}>
            Washe is only available to customers located in the Arkansas area so
            home address provided above should be an Arkansan address
          </Text>
        </View>
      </AuthLayout>
    </View>
